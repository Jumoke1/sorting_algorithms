...
/**
 *swap_list - a function to swap two nodes
...
/**
 * insertion_sort_list - a function using insertion sort to sort
...
listint_t *next_data *temp2 *temp1;
	...
	return;
	for (next_data = (*list)->next; next_data != NULL; next_data = temp)
	{
	temp 1 = next_data->next;
	temp 2 = next_data->next;
